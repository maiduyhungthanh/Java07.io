...
@Service
public class AvatarUserService {
    //tạo 1 file uploads
    private final Path rootDir = Paths.get("src/main/resources/static/img/avatar");
    ...
    //định dạng file phần Add Avatar-User
