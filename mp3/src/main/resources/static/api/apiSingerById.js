...
const getListSinger = async () => {
  ...
  editEl.innerHTML =
    `<a href="/singer-edit|${singer.id}" style="margin: 15px;" title="Chỉnh Sửa thông Tin Ca Sỹ"><img src="/img/svg/editsinger.png" alt="" width="50px"></a>`
