const API_Song = "http://localhost:1993/api/songByKeyword";
...
const Kw = x.reverse().join("").replace('?', '');
console.log(Kw)
keyword.value = Kw;
//lấy API Singer
let myPlayList = [];
...
const getListSong = async () => {
  let res = await axios.get(`http://localhost:1993/api/songByKeyword?keyword=${Kw}`);
  myPlayList = res.data;
